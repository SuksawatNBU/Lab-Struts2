		...
		<div class="card">
			...
			<div class="card-body">
				<div class="list-group">
					...
					<a href="#" class="list-group-item">ModelDriven</a>
					<a href="#" class="list-group-item">Action + ActionSupport</a>
					<a href="#" class="list-group-item">Wildcard Mapping</a>
					<a href="#" class="list-group-item">Struts Tag</a>
					<a href="jsp/globalexception/initRoom.action" class="list-group-item">Global Exception</a>
					<a href="#" class="list-group-item">OGNL</a>
				</div> 
			</div>
		</div>
