	...
	<head>
		...
		<script type="text/javascript">
			function search() {
				...
				document.forms[0].action = '<s:url value="/jsp/wildcard/searchEmail.action"/>';
				document.forms[0].submit();
			}
			
			function gotoAdd() {
				document.forms[0].action = '<s:url value="/jsp/wildcard/gotoAddEmail.action"/>';
				document.forms[0].submit();
			}
		</script>
	</head>
	<body>
		<s:form>
			<div style="width: 400px; margin-left: auto; margin-right: auto;">
				...
				<div style="width: 65%; float: left;"><s:textfield name="criteria.data.emailName" /></div>
						...
						<table>
							<thead>
								<tr>
									...
									<th style="width: 200px;">Email Name</th>
								</tr>
							</thead>
							<tbody>
								<s:iterator value="listResult" status="listResultStatus">
									<tr>
										...
										<td><s:property value="emailName" /></td>
									</tr>
								</s:iterator>
							</tbody>
						</table>
