...
<html>
	<head>
		<script type="text/javascript">
			function search() {
				document.forms[0].action = '<s:url value="/jsp/model/searchPrivileges.action"/>';
				document.forms[0].submit();
			}
		</script>
	</head>
	<body>
		<h1 align="center">Without Model Driven</h1>
		<s:form>
			<br/>
			<div style="width: 800px; margin-left: auto; margin-right: auto;">
				<div style="width: 35%; float: left;">Customer Id:</div>
				<div style="width: 65%; float: left;"><s:textfield name="privilege.customerId" /></div>
				...
				<!-- FIXME -->
				<s:if test="%{privilege.listResult.size() > 0}">
					<div style="width: 100%;">
						<table>
							<thead>
								<tr>
							...
							<tbody>
								<s:iterator value="privilege.listResult" status="listResultStatus">
									<tr>
